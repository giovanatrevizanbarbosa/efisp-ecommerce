...
public class ProductService {
    ...
    private Product mapProductDTOToEntity(ProductDTO productDTO){
        ...
        return new Product(productDTO.id(), productDTO.name(), productDTO.price()
                ,brand, productDTO.description(), department, productDTO.stock(), productDTO.image());
    }

    private ProductDTO mapProductEntityToDTO(Product product){
        return new ProductDTO(product.getId(), product.getName(), product.getPrice()
                , product.getBrand().getName(), product.getDescription(), product.getDepartment().getName(), product.getStock(), product.getImage());
    }
