...
<main class="hero bg-base-200 min-h-screen">
  ...
  <div class="hero-content flex-col lg:flex-row">
    <div class="text-center lg:text-left max-w-3xl">
      <h1 class="text-5xl font-bold">Criar Administrador</h1>
    </div>
    <div class="card bg-base-100 w-full max-w-sm shrink-0 shadow-2xl">
      <form action="add-adm" method="post" class="card-body">
        ...
        <div class="form-control">
          <label class="label">
            <span class="label-text">Escolher Cargo</span>
          </label>
          <select name="title" class="select select-bordered">
        ...
        <div class="form-control mt-6 space-y-2">
          ...
          <a href="${pageContext.request.contextPath}/home" class="btn btn-outline btn-info">Voltar</a>
        </div>
      </form>
    </div>
  </div>
