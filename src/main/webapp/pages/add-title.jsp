...
<head>
  ...
  <title>Cadastro de Departamento - E-fisp</title>
</head>
<body>
...
<main class="hero bg-base-200 min-h-screen">
  <c:if test="${result == 'notRegistered'}">
    <div role="alert" class="alert alert-error fixed top-4 left-1/2 transform -translate-x-1/2 w-fit z-50 mb-40">
      <span>Não foi possível cadastrar o departamento. Verifique os dados e tente novamente.</span>
      <div>
  ...
  <div class="hero-content flex-col lg:flex-row">
    <div class="card bg-base-100 w-full max-w-sm shrink-0 shadow-2xl">
      <form action="add-title" method="post" class="card-body">
        ...
        <div class="form-control">
          ...
          <input type="number" name="level" placeholder="nivel" class="input input-bordered" required />
        </div>
