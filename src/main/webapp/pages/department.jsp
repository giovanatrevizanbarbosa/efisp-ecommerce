...
<head>
    ...
    <title>${department.name().toUpperCase()} - E-fisp</title>
</head>
<body>
...
<main>
    <c:choose>
        <c:when test="${fn:length(products) > 0}">
            <h1 class="text-3xl font-bold my-12 text-center">Produtos em ${department.name().toUpperCase()}</h1>
        ...
        <c:otherwise>
            <div class="flex flex-col items-center justify-center h-5/6">
                ...
                <p class="text-center text-xl mt-8">Erro ao buscar produtos deste departamento.</p>
            </div>
        </c:otherwise>
    </c:choose>
    </div>
