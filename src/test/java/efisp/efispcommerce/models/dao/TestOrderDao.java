...
public class TestOrderDao implements TestDao {
    ...
    @Test
    public void add() {
        assertTrue(orderIDao.add(new Order(UUID.randomUUID(), user, new LinkedList<>(), PaymentMethod.CreditCard, address)));
    }
    ...
    public void update() {
        ...
        Order order = new Order(id, user, new LinkedList<>(), PaymentMethod.CreditCard, address);

        orderIDao.add(order);

        Order order2 = new Order(id, user, new LinkedList<>(), PaymentMethod.CreditCard, address);
    ...
    public void getAll() {
        ...
        Order order = new Order(UUID.randomUUID(), user, new LinkedList<>(), PaymentMethod.CreditCard, address);
        orderIDao.add(order);
